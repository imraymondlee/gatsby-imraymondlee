    ...
    <StyledFooter>
      <StyledFooterContainer>
        <StyledItem>
          ...
          <StyledLinkWrapper>
            <StyledLink href="mailto:imleeraymond@gmail.com" target="_blank">
        ...
        <StyledItem>
          ...
          <StyledLinkWrapper>
            <StyledLink href="https://github.com/imraymondlee" target="_blank">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      <StyledFooterSource>
        <a href="https://github.com/imraymondlee/gatsby-imraymondlee" target="_blank" rel="noreferrer"><span role="img" aria-label="Hammer and wrench">🛠️</span> Handcrafted with Gatsby</a>
      </StyledFooterSource>
    </StyledFooter>
  );
};
